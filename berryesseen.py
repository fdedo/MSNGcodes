...
sigma = 1 #volatilty
dt = 0.001 #discrete time incremen
iteration = 11
...
#TLD random numbers are extracted from a file with 10^8 deviates; shuffling and reshaping
#allows to pick once each number in the file.
